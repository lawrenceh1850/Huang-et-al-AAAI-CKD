...
-- export to csv
copy initial_features_icd_notnull to './initial_features_raw.csv' delimiter ',' csv header;
...
-- export to csv
copy initial_features_w_hadm_id_icd_notnull to './initial_features_w_hadm_id_raw.csv' delimiter ',' csv header;
10246901
